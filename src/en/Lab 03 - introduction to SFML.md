...
Create an application project according to the [Installing Qt Creator/ Creating a new project] instruction (Installing 20%20Qt%20Creator.html#creating a new project). Place the `main.cpp` file with the content downloaded from the [sfml_hello.cpp](../resources/sfml_hello.cpp) in the project.
