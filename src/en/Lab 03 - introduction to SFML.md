...
Create an application project according to the [Qt Creator installation/Creating a new project] instruction. Place the `main.cpp` file with the content downloaded from the [sfml_hello.cpp](../resources/sfml_hello.cpp) in the project.
